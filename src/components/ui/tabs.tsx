...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={clsx(
      ...
      'ring-offset-slate-900 transition-all focus-visible:outline-none focus-visible:ring-2',
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={clsx(
      'mt-2 ring-offset-slate-900 focus-visible:outline-none focus-visible:ring-2',
      'focus-visible:ring-blue-500 focus-visible:ring-offset-2',
      className
    )}
    {...props}
